...
user in an INI file next to EvincePortable.exe called EvincePortable.ini.
...
copy AppNamePortable.ini from this directory to EvincePortable.ini next to
EvincePortable.exe. The options in the INI file are as follows:
