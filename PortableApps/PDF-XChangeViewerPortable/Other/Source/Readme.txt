...
user in an INI file next to PDF-XChangeViewerPortable.exe called PDF-XChangeViewerPortable.ini.
...
copy AppNamePortable.ini from this directory to PDF-XChangeViewerPortable.ini next to
PDF-XChangeViewerPortable.exe. The options in the INI file are as follows:
