...
user in an INI file next to SigilPortable.exe called SigilPortable.ini.
...
copy AppNamePortable.ini from this directory to SigilPortable.ini next to
SigilPortable.exe. The options in the INI file are as follows:
