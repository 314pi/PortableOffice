...
user in an INI file next to SpeedCrunchPortable.exe called SpeedCrunchPortable.ini.
...
copy AppNamePortable.ini from this directory to SpeedCrunchPortable.ini next to
SpeedCrunchPortable.exe. The options in the INI file are as follows:
