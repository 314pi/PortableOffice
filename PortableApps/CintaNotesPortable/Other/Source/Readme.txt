...
user in an INI file next to CintaNotesPortable.exe called CintaNotesPortable.ini.
...
copy AppNamePortable.ini from this directory to CintaNotesPortable.ini next to
CintaNotesPortable.exe. The options in the INI file are as follows:
