...
user in an INI file next to KeepNotePortable.exe called KeepNotePortable.ini.
...
copy AppNamePortable.ini from this directory to KeepNotePortable.ini next to
KeepNotePortable.exe. The options in the INI file are as follows:
