...
user in an INI file next to KchmViewerPortable.exe called KchmViewerPortable.ini.
...
copy AppNamePortable.ini from this directory to KchmViewerPortable.ini next to
KchmViewerPortable.exe. The options in the INI file are as follows:
