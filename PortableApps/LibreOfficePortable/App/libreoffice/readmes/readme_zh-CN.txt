...
LibreOffice 社区负责此产品的开发，我们邀请您参与进来，成为全球社区中的一员。如果您是新用户，可以访问 LibreOffice 网站查阅 LibreOffice 项目以及相关信息。访问 http://zh-cn.libreoffice.org。
...
RPMS 或 DEBS 目录中分别还包含名为 libreoffice6.0-freedesktop-menus-6.0.0.1-1.noarch.rpm (或者 libreoffice6.0-debian-menus_6.0.0.1-1_all.deb)（或类似的）的软件包。该软件包可供所有支持 Freedesktop.org  规范/推荐 (http://en.wikipedia.org/wiki/Freedesktop.org) 的 Linux 发行版使用，也可在前文说明中未提及的其他 Linux 发行版中安装。
...
当前我们使用 BugZilla 报告、追踪和解决 bug。该系统托管在 https://bugs.libreoffice.org/。我们鼓励所有的用户觉得自己有权力，而且很欢迎，报告在您特定的平台中遇到的 bug。积极的报告 bug 是用户社区能为持续开发并改进的 LibreOffice 所做的最重要的贡献。
...
开始贡献最简单的方式是订阅一个或多个邮件列表，潜水一段时间，并逐渐使用邮件列表归档熟悉自 2000 年 10 月 LibreOffice 源码发布以来所涉及到的诸多话题。当您方便时，唯一要做的就是发送一封自我介绍的邮件并加入讨论。如果您熟悉开源项目，请查看我们位于 http://www.libreoffice.org/develop/ 的 To-Do 列表，看是否有您能帮到忙的地方。
...
我们希望您能够愉快地使用新的 LibreOffice 6.0 并在线加入我们。
