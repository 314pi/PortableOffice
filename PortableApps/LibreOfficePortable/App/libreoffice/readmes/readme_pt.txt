...
O diretório de RPMS (OU DEBS) também contém um pacote com o nome libreoffice6.0-freedesktop-menus-6.0.0.1-1.noarch.rpm (ou libreoffice6.0-debian-menus_6.0.0.1-1_all.deb, respetivamente, ou similar). Este é o pacote a utilizar para todas as distribuições Linux que cumpram as especificações/recomendações Freedesktop.org (http://en.wikipedia.org/wiki/Freedesktop.org) e é disponibilizado para a instalação em outras distribuições Linux que não estejam abrangidas pelas instruções acima mencionadas.
...
Esperamos que o novo LibreOffice 6.0 corresponda às suas expectativas e aguardamos a sua integração na equipa.
