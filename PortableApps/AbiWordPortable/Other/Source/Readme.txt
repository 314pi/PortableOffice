...
user in an INI file next to AbiWordPortable.exe called AbiWordPortable.ini.
...
copy AppNamePortable.ini from this directory to AbiWordPortable.ini next to
AbiWordPortable.exe. The options in the INI file are as follows:
