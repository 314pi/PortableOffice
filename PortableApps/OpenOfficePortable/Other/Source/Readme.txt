...
user in an INI file next to OpenOfficePortable.exe called OpenOfficePortable.ini.
...
copy AppNamePortable.ini from this directory to OpenOfficePortable.ini next to
OpenOfficePortable.exe. The options in the INI file are as follows:
