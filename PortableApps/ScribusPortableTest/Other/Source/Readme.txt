...
user in an INI file next to Scribus-ngPortable.exe called Scribus-ngPortable.ini.
...
copy AppNamePortable.ini from this directory to Scribus-ngPortable.ini next to
Scribus-ngPortable.exe. The options in the INI file are as follows:
