...
user in an INI file next to CuteMarkEdPortable.exe called CuteMarkEdPortable.ini.
...
copy AppNamePortable.ini from this directory to CuteMarkEdPortable.ini next to
CuteMarkEdPortable.exe. The options in the INI file are as follows:
