...
user in an INI file next to CherryTreePortable.exe called CherryTreePortable.ini.
...
copy AppNamePortable.ini from this directory to CherryTreePortable.ini next to
CherryTreePortable.exe. The options in the INI file are as follows:
