...
user in an INI file next to ZoomItPortable.exe called ZoomItPortable.ini.
...
copy AppNamePortable.ini from this directory to ZoomItPortable.ini next to
ZoomItPortable.exe. The options in the INI file are as follows:
